module.exports = function createReceiptEmail(username, verifyHash) {
    ...
    <div style="margin: auto; padding: 50px; max-width: 670px;">
      ...
      <p style="font-size: 16px; color: #51545E; font-family: 'Nunito Sans', sans-serif; margin-bottom: 20px;">Thanks for signing up for an account with Ultimate Penny Trader. To complete the registration process, please click the Verify Account button below.</p>
      ...
      <a style="text-decoration: none; color: white;" href="${process.env.FRONT_END_VERIFY_URL + "?hash=" + verifyHash}">Verify Account</a>
        ...
        <p style="font-size: 16px; color: #51545E; font-family: 'Nunito Sans', sans-serif; margin-bottom: 20px;">If you did not sign up for an Ultimate Penny Trader account, please simply delete or ignore this email, and you won't recieve any more emails from us.</p>
    </div>`
